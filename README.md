...
| 페이지 | URL | 내용 |
|--------|-----|------|
| 홈 | `/` | 프로필, 활동 히스토리, 기술 스택 (언어, DB, 서버, 디자인, 하드웨어, IDE / 에디터, 자격증) |
